...
void D_e_Sys_v_run() {
    ...
    draw_text(framebuffer, 250, 110, "| D.eSystem version: D.eSystem 6.0.6 alpha                                                                 |", 0xFFFFFF);
    ...
    draw_text(framebuffer, 250, 150, "| UX version: Color UX D.eSystem edition                                                                   |", 0xFFFFFF);
